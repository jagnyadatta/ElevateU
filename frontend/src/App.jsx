...
function App() {
  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      <div 
        className="inset-0 w-full h-full flex items-center justify-center opacity-50 mt-40"
      >
        <img src={imaLogo} alt="homepage image" className='w-[50vw] md:w-[45vw]' />
      </div>

      {/* Blue Overlay with Blur Effect */}
      <div className="fixed inset-0 w-full h-full bg-gray-300/20 backdrop-blur-xl z-[10]"></div>
