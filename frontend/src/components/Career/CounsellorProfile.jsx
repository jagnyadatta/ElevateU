...
const CounsellorProfile = () => {
  ...
  const starImage = "https://upload.wikimedia.org/wikipedia/commons/4/44/Plain_Yellow_Star.png";
  ...
  return (
    <div className="flex min-h-screen p-6 pl-[400px] mt-[50px]">
      ...
      <div className="w-[350px] fixed top-[70px] left-6 bg-white p-6 rounded-2xl shadow-lg h-[90vh] flex flex-col items-center justify-start">
        ...
        <div className="flex flex-col space-y-4 text-gray-700 w-full mb-6">
          ...
          <div>
            ...
            <h2 className="text-lg font-semibold">MIT - Massachusetts Institute of Technology</h2>
          </div>

          <div>
            <p className="text-sm text-gray-500">Branch Name</p>
            <h2 className="text-lg font-semibold">Computer Science Engineering</h2>
          </div>
      ...
      <div className="flex-1 pl-8 space-y-6">
        ...
        {/* Rating Section */}
        <div className="bg-white p-6 rounded-2xl shadow-lg">
          <h3 className="text-2xl font-bold mb-4">Rating</h3>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg">
          <h3 className="text-2xl font-bold mb-4">Make Student Concern With John</h3>
