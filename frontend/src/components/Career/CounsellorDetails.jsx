...
const CounsellorDetails = () => {
  ...
  return (
    <div className="p-10 max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold text-[#3b66ff] mb-6">Counsellor Details</h2>
      <div className="bg-white p-6 rounded-lg shadow space-y-4">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p><strong>College:</strong> {counsellor?.collegeName}</p>
            <p><strong>Branch:</strong> {counsellor?.branch}</p>
            <p><strong>Year:</strong> {counsellor?.passoutYear}</p>
            <p><strong>Status:</strong> {counsellor?.verification}</p>
          </div>
        </div>

        <div>
          <h3 className="text-lg font-semibold mb-2 text-[#3b66ff]">Uploaded Documents</h3>
          <div className="flex gap-4">
            <img
              src={counsellor?.collegeIdCard}
              alt="Document 1"
              className="w-90 h-auto rounded-lg border"
            />
            <img
