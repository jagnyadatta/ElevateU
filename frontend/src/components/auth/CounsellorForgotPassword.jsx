...
const CounsellorForgotPassword = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${COUNSELLOR_API_END_POINT}/forgot/send-otp`,
        { email }
      );
      if (res.data.success) {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
        setLoader(true);
      const res = await axios.post(
        `${COUNSELLOR_API_END_POINT}/forgot/verify-otp`,
        { email, otp }
      );
      if (res.data.success) {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
        setLoader(true);
      const res = await axios.post(
        `${COUNSELLOR_API_END_POINT}/forgot/Update-password`,
        {
          email,
